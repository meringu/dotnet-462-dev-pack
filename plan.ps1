...
$pkg_origin="meringu"
$pkg_version="4.6.2"
$pkg_description=".NET 4.6.2 Targeting Pack and the .NET 4.6.2 SDK."
$pkg_upstream_url="https://www.microsoft.com/en-us/download/details.aspx?id=53321"
...
$pkg_bin_dirs=@("Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.2 Tools\x64")
$pkg_lib_dirs=@("Program Files (x86)\Windows Kits\NETFXSDK\4.6.2\Lib\um\x64")
$pkg_include_dirs=@("Program Files (x86)\Windows Kits\NETFXSDK\4.6.2\Include\um")
